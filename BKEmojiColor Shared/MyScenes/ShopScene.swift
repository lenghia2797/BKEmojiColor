...
//    let backBtn = Button(normalName: "img_home", size: CGSize.withPercentScaled(roundByWidth: 15), position: CGPoint.withPercent(10, y: 93), zPosition: GameConfig.zPosition.layer_3)
...
//    let coinLbl = Label(text: "0", fontSize: 30, fontName: GameConfig.fontNumber, color: UIColor.white, position: CGPoint.zero, zPosition: GameConfig.zPosition.layer_5)
    ...
    let toastLbl = Label(text: "You do not have enough coins to buy!", fontSize: 20, fontName: GameConfig.fontNumber, color: UIColor.white, position: CGPoint.zero, zPosition: GameConfig.zPosition.layer_5)
    ...
    func updateProtect(_ value: Int) {
        ...
        UserDefaults.standard.set(currentBlood, forKey: GameConfig.currentProtect)
    }
